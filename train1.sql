...
ALTER TABLE trains auto_increment=1023;

INSERT INTO irctc.trains(`trainname`,`activedays`,`locopilotID`,`originstation`,`destinationstation`,`pickupstation`,`journeytime`)
values
